...
public class CName {
	 ...
	 public static LinkedHashMap<String,String> unitchange(){
		...
		unit.put("Volume","m3"); 
		unit.put("Time","a"); 
		unit.put("Quadratmeter","qm"); 
		unit.put("kgkm","kgkm"); 
		unit.put("Piece","pcs."); 
		unit.put("Referenzfenster 1,23m x 1,48m, Rahmenanteil zwischen 25% und 35%","pcs."); 
		unit.put("Kilogramm","kg"); 
		unit.put("Kilogram","kg"); 
		unit.put("Cubicmeter","m3"); 
		unit.put("Stück pro Produkt","pcs."); 
